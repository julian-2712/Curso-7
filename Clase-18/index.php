...
$autor->create_post($php_functions_post);
$autor->create_post($vue_app_post);

// Y por último listamos los posts
$author_post = $autor->get_postst();

foreach ($author_post as $post) {
    
    echo "El usuario {$autor->get_full_name()} tiene el siguiente post: <br><br>";
    echo $post->get_post();
    echo "<br><br><br>";
